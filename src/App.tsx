...
export default function App() {
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 flex flex-col selection:bg-indigo-500/30">
      ...
      */}
      <main className="flex-1 flex items-center justify-center px-2 py-4 pt-18 min-h-[calc(100vh-64px)]">
        <div className="w-full max-w-3xl bg-zinc-900/30 border border-zinc-800/60 p-2  shadow-2xl backdrop-blur-md">
